...
from model_dave2_const_v_b_CIL import DrivingModel, DrivingDataset, DrivingDataModule
...
if __name__ == "__main__":
    ...
    model = DrivingModel.load_from_checkpoint(model_path, learning_rate = 1e-5)
