...
def main():
    ...
    try:
        ...
        camera_left_transform = carla.Transform(carla.Location(x = 1.5,y = -camera_y_offset, z = 1.5))
        left_sensor = world.spawn_actor(rgb_bp, camera_left_transform, attach_to=vehicle)
        actor_list.append(left_sensor)

        camera_right_transform = carla.Transform(carla.Location(x = 1.5,y = camera_y_offset, z = 1.5))
        ...
        while True:
            ...
            # cv2.putText(image_left, f"{v_kmh:.1f}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255),2)
